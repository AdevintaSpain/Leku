...
class AndroidGeocoderDataSource(
    private val geocoder: Geocoder,
) : GeocoderDataSourceInterface {
    override suspend fun autoCompleteFromLocationName(query: String): List<PlaceSuggestion> = emptyList()

    override suspend fun getAddressFromPlaceId(placeId: String): Address? = null
