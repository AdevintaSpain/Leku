...
data class SearchZoneRect(
    ...
    companion object CREATOR : Parcelable.Creator<SearchZoneRect> {
        override fun createFromParcel(parcel: Parcel): SearchZoneRect = SearchZoneRect(parcel)

        override fun newArray(size: Int): Array<SearchZoneRect?> = arrayOfNulls(size)
    }
}
