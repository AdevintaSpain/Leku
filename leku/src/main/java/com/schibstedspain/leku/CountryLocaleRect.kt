...
internal object CountryLocaleRect {
  ...
  fun getLowerLeftFromZone(locale: Locale): LatLng? {
    when {
      Locale.US == locale -> return US_LOWER_LEFT
      Locale.UK == locale -> return UK_LOWER_LEFT
      Locale.FRANCE == locale -> return FRANCE_LOWER_LEFT
      Locale.ITALY == locale -> return ITALY_LOWER_LEFT
      Locale.GERMANY == locale -> return GERMANY_LOWER_LEFT
      Locale.GERMAN == locale -> return GERMAN_LOWER_LEFT
      locale.toString().equals(UAE_COUNTRY_CODE, ignoreCase = true) -> return UAE_LOWER_LEFT
      locale.toString().equals(INDIA_COUNTRY_CODE, ignoreCase = true) -> return INDIA_LOWER_LEFT
      locale.toString().equals(SPAIN_COUNTRY_CODE, ignoreCase = true) -> return SPAIN_LOWER_LEFT
      locale.toString().equals(PAKISTAN_COUNTRY_CODE, ignoreCase = true) -> return PAKISTAN_LOWER_LEFT
      else -> return null
    }
  }
  ...
  fun getUpperRightFromZone(locale: Locale): LatLng? {
    when {
      Locale.US == locale -> return US_UPPER_RIGHT
      Locale.UK == locale -> return UK_UPPER_RIGHT
      Locale.FRANCE == locale -> return FRANCE_UPPER_RIGHT
      Locale.ITALY == locale -> return ITALY_UPPER_RIGHT
      Locale.GERMANY == locale -> return GERMANY_UPPER_RIGHT
      Locale.GERMAN == locale -> return GERMAN_UPPER_RIGHT
      locale.toString().equals(UAE_COUNTRY_CODE, ignoreCase = true) -> return UAE_UPPER_RIGHT
      locale.toString().equals(INDIA_COUNTRY_CODE, ignoreCase = true) -> return INDIA_UPPER_RIGHT
      locale.toString().equals(SPAIN_COUNTRY_CODE, ignoreCase = true) -> return SPAIN_UPPER_RIGHT
      locale.toString().equals(PAKISTAN_COUNTRY_CODE, ignoreCase = true) -> return PAKISTAN_UPPER_RIGHT
      else -> return null
    }
  }
}
